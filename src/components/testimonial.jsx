...
const testimonialsData = [
  {
    quote:
      "Working withSPARK CABANA  was a game-changer. Their SEO strategy doubled our organic traffic in just six months. We couldn't be happier with the results.",
    name: "Sarah Johnson",
  ...
  {
    quote:
      "As a local business, we struggled to get noticed online.SPARK CABANA 's local SEO services put us on the map. Our foot traffic has increased by over 70%.",
