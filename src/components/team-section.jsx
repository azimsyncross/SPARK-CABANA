...
const teamData = [
  {
    ...
    icon: User,
    bio: `With comprehensive expertise in digital marketing strategy, ${contactInfo.contactPerson} directs our company vision and client partnerships. A recognized authority in growth acceleration and business transformation, he establishedSPARK CABANA  with the mission to enable businesses to achieve digital marketplace excellence.`,
