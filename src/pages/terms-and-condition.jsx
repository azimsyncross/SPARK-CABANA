      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto max-w-4xl px-4">
          ...
          >
            ...
            >
              By accessing and using the services provided by SPARK CABANA , you
            ...
            >
              SPARK CABANA provides digital marketing services including but not
              limited to:
            </motion.p>
            <motion.ul
              variants={contentVariants}
            ...
            >
              ...
              <motion.li variants={contentVariants}>
                SPARK CABANA retains ownership of methodologies, processes, and
                tools
              </motion.li>
              <motion.li variants={contentVariants}>
            ...
            <motion.p
              ...
              className="mb-4 text-muted-foreground"
            >
              SPARK CABANA 's liability is limited as follows:
            </motion.p>
            <motion.ul
              variants={contentVariants}
              className="list-disc list-inside ml-4 space-y-2 mb-6 text-muted-foreground"
